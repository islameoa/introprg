...
public class Vi {
    ...
    public boolean esValid() {
        if (this.ref != null && this.nom != null && this.preu != -1 && this.estoc != -1 && this.lloc != null
                && this.origen != null && this.tipus != null && this.collita != null) {
            return true;
        } else {
            return false;
        }
    ...
    // rep un array de Strings amb els atributs del vi i retorna un vi amb aquests
    // atributs
    public static Vi deArrayString(String[] vi) {
        ...
        try {
            ...
            if (preu < 0 || estoc < 0 || vi[0] == null || vi[1] == null || vi[4] == null || vi[5] == null
                    || vi[6] == null || vi[7] == null) {
                return null;
            }
